# ================================================
# EAS - Very Severe COVID-19 (A2) vs AMI
# ================================================
...
# ==================== Exposure: COVID-19 (C2) - East Asian ====================
exposure_raw <- fread("./COVID-19_AMI_All/COVID19_HGI_C2_ALL_eas_leave23andme_20220403.tsv.gz")
...
ggsave("results/figures/EAS_C2_forest.png", mr_forest_plot(mr_singlesnp(mr_dat))[[1]], width = 10, height = 8)
ggsave("results/figures/EAS_C2_leaveoneout.png", mr_leaveoneout_plot(mr_leaveoneout(mr_dat))[[1]], width = 10, height = 8)
ggsave("results/figures/EAS_C2_funnel.png", mr_funnel_plot(mr_singlesnp(mr_dat))[[1]], width = 8, height = 6)

# ==================== Sensitivity Tests ====================
mr_heterogeneity(mr_dat)
mr_pleiotropy_test(mr_dat)

cat("EAS C2 Analysis Completed Successfully\n")
