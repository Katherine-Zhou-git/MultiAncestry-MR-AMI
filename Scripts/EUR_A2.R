# ================================================
# EUR - Very Severe COVID-19 (A2) vs AMI
# ================================================
...
# Exposure: Very Severe COVID-19 (A2) - EUR
exposure_raw <- fread("./COVID-19_AMI_All/COVID19_HGI_A2_ALL_eur_leave23andme_20220403.tsv.gz")
...
exposure_c1$exposure <- "Very_Severe_COVID19_A2_EUR"
...
write.csv(mr_dat, "./EUR_A2_mr_dat.csv", row.names = FALSE)
...
write.csv(odd, "./EUR_A2_results.csv", row.names = FALSE)
...
ggsave("./EUR_A2_scatter.png", mr_scatter_plot(res, mr_dat)[[1]], width = 8, height = 6)
ggsave("./EUR_A2_forest.png", mr_forest_plot(singlesnp_res)[[1]], width = 10, height = 8)
ggsave("./EUR_A2_leaveoneout.png", mr_leaveoneout_plot(mr_leaveoneout(mr_dat))[[1]], width = 10, height = 8)
ggsave("./EUR_A2_funnel.png", mr_funnel_plot(singlesnp_res)[[1]], width = 8, height = 6)

# ==================== Sensitivity Tests ====================
mr_heterogeneity(mr_dat)
mr_pleiotropy_test(mr_dat)

cat("EUR A2 Analysis Completed Successfully\n")
