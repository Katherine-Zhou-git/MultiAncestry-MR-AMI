...
# Exposure: COVID-19 Infection (C2) - South Asian
...
exposure_c1$exposure <- "COVID19_Infection_C2_SAS"
...
write.csv(mr_dat, "./SAS_C2_mr_dat.csv", row.names = FALSE)
...
write.csv(odd, "./SAS_C2_results.csv", row.names = FALSE)
...
ggsave("./SAS_C2_scatter.png", mr_scatter_plot(res, mr_dat)[[1]], width = 8, height = 6)
ggsave("./SAS_C2_forest.png", mr_forest_plot(singlesnp_res)[[1]], width = 10, height = 8)
ggsave("./SAS_C2_leaveoneout.png", mr_leaveoneout_plot(mr_leaveoneout(mr_dat))[[1]], width = 10, height = 8)
ggsave("./SAS_C2_funnel.png", mr_funnel_plot(singlesnp_res)[[1]], width = 8, height = 6)
