...
write.csv(mr_dat, "./AFR_C2_mr_dat.csv", row.names = FALSE)
...
write.csv(odd, "./AFR_C2_results.csv", row.names = FALSE)
...
ggsave("./AFR_C2_scatter.png", mr_scatter_plot(res, mr_dat)[[1]], width = 8, height = 6)
ggsave("./AFR_C2_forest.png", mr_forest_plot(singlesnp_res)[[1]], width = 10, height = 8)
ggsave("./AFR_C2_leaveoneout.png", mr_leaveoneout_plot(mr_leaveoneout(mr_dat))[[1]], width = 10, height = 8)
ggsave("./AFR_C2_funnel.png", mr_funnel_plot(singlesnp_res)[[1]], width = 8, height = 6)

# ==================== Sensitivity Tests ====================
mr_heterogeneity(mr_dat)
mr_pleiotropy_test(mr_dat)

cat("AFR C2 Analysis Completed Successfully\n")
