# ================================================
# East Asian - Hospitalized COVID-19 (B2) vs AMI 
# ================================================
...
exposure_c1$exposure <- "Hospitalized_COVID19_B2_EAS"
...
write.csv(odd, "./EAS_B2_results.csv", row.names = FALSE)
...
ggsave("./EAS_B2_scatter.png", mr_scatter_plot(res, mr_dat)[[1]], width = 8, height = 6)
ggsave("./EAS_B2_forest.png", mr_forest_plot(singlesnp_res)[[1]], width = 10, height = 8)
ggsave("./EAS_B2_leaveoneout.png", mr_leaveoneout_plot(mr_leaveoneout(mr_dat))[[1]], width = 10, height = 8)
ggsave("./EAS_B2_funnel.png", mr_funnel_plot(singlesnp_res)[[1]], width = 8, height = 6)
