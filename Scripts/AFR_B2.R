# ================================================
# African - Hospitalized COVID-19 (B2) vs AMI 
# ================================================
...
# Exposure: Hospitalized COVID-19 (B2) - African
exposure_raw <- fread("./COVID-19_AMI_All/COVID19_HGI_B2_ALL_afr_leave23andme_20220403.tsv.gz")
...
exposure_c1$exposure <- "Hospitalized_COVID19_B2_AFR"
exposure_c1$id.exposure <- "covid_b2_afr"
...
exposure_snps <- ld_clump(dat = exposure_c1, clump_kb = 10000, clump_r2 = 0.001,
                          plink_bin = genetics.binaRies::get_plink_binary(), bfile = "./1kg.v3/AFR")
...
outcome_ss1$id.outcome <- "ami_afr"
...
write.csv(mr_dat, "./AFR_B2_mr_dat.csv", row.names = FALSE)
...
write.csv(odd, "./AFR_B2_results.csv", row.names = FALSE)
...
ggsave("./AFR_B2_scatter.png", mr_scatter_plot(res, mr_dat)[[1]], width = 8, height = 6)
ggsave("./AFR_B2_forest.png", mr_forest_plot(singlesnp_res)[[1]], width = 10, height = 8)
ggsave("./AFR_B2_leaveoneout.png", mr_leaveoneout_plot(mr_leaveoneout(mr_dat))[[1]], width = 10, height = 8)
ggsave("./AFR_B2_funnel.png", mr_funnel_plot(singlesnp_res)[[1]], width = 8, height = 6)

# ==================== Sensitivity Tests ====================
mr_heterogeneity(mr_dat)
mr_pleiotropy_test(mr_dat)

cat("AFR B2 Analysis Completed Successfully\n")
