...
data_euro <- data.frame(
  ...
  OR = c(
    # C2 - COVID-19 Infection (13 SNPs)
    0.9750433594, 0.946078866, 0.9217779187, 0.9217779187, 0.940398275,
    # B2 - Hospitalized COVID-19 (28 SNPs)
    0.9861703958, 0.9681659895, 0.9417101058, 0.9417101058, 0.972723204,
    # A2 - Very Severe COVID-19 (24 SNPs)
    1.005610474, 0.9792187756, 0.9490921311, 0.9490921311, 0.9848935296
  ),
  
  CI_lower = c(
    # C2
    0.7946704998, 0.8058418744, 0.8179150207, 0.8399098997, 0.7893471651,
    # B2
    0.8927291178, 0.9046653489, 0.9027239012, 0.8924227957, 0.9138048761,
    # A2
    0.940366061, 0.9390383068, 0.9216872312, 0.9130532192, 0.9450356305
  ),
  
  CI_upper = c(
    # C2
    1.196356922, 1.110720663, 1.038829842, 1.011625809, 1.120354839,
    # B2
    1.089392101, 1.036123893, 0.9823800191, 0.9937194878, 1.03544034,
    # A2
    1.07538167, 1.021118525, 0.977311872, 0.9865535266, 1.026432479
  ),
  
  p_val = c(
    # C2
    0.8131085418, 0.4983081879, 0.1817391725, 0.08608489018, 0.5046093804,
    # B2
    0.7861000248, 0.3499369469, 0.005367849609, 0.02854528564, 0.3932990152,
    # A2
    0.8716397588, 0.3259147569, 0.0004737258267, 0.008158891714, 0.4774528386
  ),
